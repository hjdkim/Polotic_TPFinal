    ...
    <body>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <h3 class="mt-2 text-center">Modificar paquete</h3>
                </div>
                    ...
                    <div class="mx-auto">
                        <form action="SvModificar" method="POST">
                            <table id="tabla_servicios" class="table">
                                ...
                                <tbody>
                                    <%  Paquete paque = (Paquete) misession.getAttribute("paqueAModificar");
                            ...
                            <div>
                                <input type="hidden" name="modificarPaque" value="<%=paque.getCodigo_paquete()%>">
