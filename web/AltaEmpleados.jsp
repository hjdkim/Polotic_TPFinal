    ...
    <body>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <h3 class="mt-2 text-center">Nuevo Empleado</h3>
                </div>
                    ...
                    <div class="mx-auto">
                        <form action="SvEmpleado" method="POST">
                            ...
                            <div>
                                ...
                                <input type="text" name="cargo" id="cargo" class="form-control mb-2">
                            </div>
                            <div>
                                <label for="sueldo" class="form-label">Sueldo: </label>
                                <input type="number" name="sueldo" id="sueldo" class="form-control mb-2">
                            </div>
                            <div>
                                <label for="nombreUsu" class="form-label">Nombre de usuario: </label>
                                <input type="text" name="nombreUsu" id="nombreUsu" class="form-control mb-2">
                            </div>
                            <div>
                                <label for="contrasenia" class="form-label">Contraseña: </label>
                                <input type="password" name="contrasenia" id="contrasenia" class="form-control mb-2">
                            </div>
                            <div>
